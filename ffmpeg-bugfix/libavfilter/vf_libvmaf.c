...
static const AVOption libvmaf_options[] = {
    {"format",  "Set the pixel format to be used for computing vmaf.",                  OFFSET(format), AV_OPT_TYPE_STRING, {.str="yuv420p"}, 0, 1, FLAGS},
    ...
    {"psnr",  "Enables computing psnr along with vmaf.",                                OFFSET(psnr), AV_OPT_TYPE_BOOL, {.i64=1}, 0, 1, FLAGS},
    {"ssim",  "Enables computing ssim along with vmaf.",                                OFFSET(ssim), AV_OPT_TYPE_BOOL, {.i64=1}, 0, 1, FLAGS},
    {"ms_ssim",  "Enables computing ms-ssim along with vmaf.",                          OFFSET(ms_ssim), AV_OPT_TYPE_BOOL, {.i64=0}, 0, 1, FLAGS},
    {"pool",  "Set the pool method to be used for computing vmaf.",                     OFFSET(pool), AV_OPT_TYPE_STRING, {.str=NULL}, 0, 1, FLAGS},
//    {"thread",  "Enables computing ssim along with vmaf.",                              OFFSET(thread), AV_OPT_TYPE_INT, {.i64=0}, 0, 10, FLAGS},
//    {"subsample",  "Enables computing ssim along with vmaf.",                           OFFSET(subsample), AV_OPT_TYPE_INT, {.i64=1}, 0, 10, FLAGS},
//    {"enable_conf_interval",  "Enables computing ssim along with vmaf.",                OFFSET(enable_conf_interval), AV_OPT_TYPE_BOOL, {.i64=0}, 0, 1, FLAGS},
    { NULL }
};
...
*/
    compute_vmaf(&s->vmaf_score, s->format, s->width, s->height, read_frame, s,
                                 s->model_path, s->log_path, s->log_fmt, 0, 0,
                                 s->enable_transform, s->phone_model, s->psnr,
                                 s->ssim, s->ms_ssim, s->pool);
}
...
{
    LIBVMAFContext *s = (LIBVMAFContext *) ctx;
    av_log(ctx, AV_LOG_INFO, "compute_vmaf_score\n");
...
//    av_log(ctx, AV_LOG_INFO, "do_vmaf\n");
...
{
//    av_log(ctx, AV_LOG_INFO, "query_formats\n");
...
static int config_input_ref(AVFilterLink *inlink)
{
    ...
    av_log(ctx, AV_LOG_INFO, "config_input_ref\n");
